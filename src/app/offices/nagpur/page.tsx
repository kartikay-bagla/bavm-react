...
export default function NagpurOffice() {
  const officeData = content.contact.branchOffices.offices.find(office => office.name === 'Nagpur');
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-center mb-8">Branch Office - Nagpur</h1>
