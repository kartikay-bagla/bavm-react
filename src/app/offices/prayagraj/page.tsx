...
export default function PrayagrajOffice() {
  const officeData = content.contact.branchOffices.offices.find(office => office.name === 'Prayagraj');
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-center mb-8">Branch Office - Prayagraj</h1>
