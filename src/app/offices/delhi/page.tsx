...
export default function DelhiOffice() {
  const officeData = content.contact.corporateOffice;

  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-center mb-8">Corporate Office - Delhi</h1>
        ...
        <div className="bg-gray-50 shadow-lg rounded-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-[40%_60%] items-center min-h-[400px]">
            <div className="p-8 space-y-6">
              <h2 className="text-2xl font-bold mb-4">{officeData.title}</h2>
            ...
            <div className="h-full">
              <iframe
                ...
                allowFullScreen
                loading="lazy"
                title="BAVM Legal Corporate Office - Delhi"
              ></iframe>
            </div>
          </div>
        </div>
